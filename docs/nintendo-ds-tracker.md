# PPLSYLLABUSDS: Nintendo DS Training Tracker

[Back to Aviator Prompts](../README.md)

**Status:** Experimental homebrew prototype. The instructions below preserve the original project setup; a fresh device build has not been validated as part of this documentation update.
