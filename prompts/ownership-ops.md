...
Known trouble spots: [optional]

Give me:
- A preflight flow outline (outside then inside)
...
- Student/training notes (if applicable)
- Action items list
...
- Remove redundancy but keep intent
- Highlight safety-critical items
- Keep wording conservative; do not add steps not supported by the original text
