...
- Relevant indications (gauge, light, smell, sound)
- Repro steps if possible
- Operational limitation recommendation (if any)
...
Aircraft: [TYPE]
Field: [IDENT]
Weather: [VMC/IMC], winds: [PASTE]

Create an acceptance flight plan:
- Ground checks
- Taxi checks
- Takeoff and initial climb checks
- Enroute checks (step-by-step)
...
2) [Option B] cost [X], lead time [Y], warranty [Z]
3) [Option C] ...
